...
<!--                    <li><a href="#">T-Shirts</a></li>-->
            ...
            <div class="col-sm-6 col-md-3">     <!--- col-sm-6 col-md-3 Starts --->
                ...
                <p>     <!--- p Starts --->
                    ...
                    <br>
                    <strong>Chiranjit Sarkar</strong>
                </p>       <!--- p Ends --->
                <a href="../contact.php">Go to our Contact Us Page</a>
                <hr class="hidden-md hidden-lg">
            </div>      <!--- col-sm-6 col-md-3 Ends --->

            <div class="col-md-3 col-sm-6">     <!--- col-sm-6 col-md-3 Starts --->
                <h4>Get the news</h4>
                <p class="text-muted">
